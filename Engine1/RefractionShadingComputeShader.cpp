...
{
    if ( m_compiled ) throw std::exception( "RefractionShadingComputeShader::compileFromFile - Shader has already been compiled." );
...
void RefractionShadingComputeShader::setParameters( ID3D11DeviceContext& deviceContext, const float3& cameraPos,
