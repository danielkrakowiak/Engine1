...
void ControlPanel::initialize( Microsoft::WRL::ComPtr< ID3D11Device >& device, const int2 windowDimensions )
{
    ...
    TwAddVarRW( tweakBar, "Alpha mul", TW_TYPE_FLOAT, &Settings::s_settings.debug.alphaMul, "min=0 max=1 step=0.005 precision=3" );
    ...
    TwAddVarRW( tweakBar, "Metalness mul", TW_TYPE_FLOAT, &Settings::s_settings.debug.metalnessMul, "min=0 max=1 step=0.005 precision=3" );
    TwAddVarRW( tweakBar, "Roughness mul", TW_TYPE_FLOAT, &Settings::s_settings.debug.roughnessMul, "min=0 max=1 step=0.005 precision=3" );
    TwAddVarRW( tweakBar, "Refractive index mul", TW_TYPE_FLOAT, &Settings::s_settings.debug.refractiveIndexMul, "min=0 max=1 step=0.005 precision=3" );
}
