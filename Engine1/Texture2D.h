...
namespace Engine1
{
           ...
           public Texture2DSpecBind< TexBind::ShaderResource, PixelType >
    {
        ...
        Texture2D( ID3D11Device3& device, const Texture2DFileInfo& fileInfo, const bool storeOnCpu, const bool storeOnGpu,
        ...
        Texture2D( ID3D11Device3& device, std::vector<char>::const_iterator dataIt, std::vector<char>::const_iterator dataEndIt,
        ...
        Texture2D( ID3D11Device3& device, const int width, const int height, const bool storeOnCpu, const bool storeOnGpu,
        ...
        Texture2D( ID3D11Device3& device, const std::vector< PixelType >& data, const int width, const int height,
           ...
           public Texture2DSpecBind< TexBind::RenderTarget, PixelType >
    {
        ...
        Texture2D( ID3D11Device3& device, Microsoft::WRL::ComPtr<ID3D11Texture2D>& texture ) :
