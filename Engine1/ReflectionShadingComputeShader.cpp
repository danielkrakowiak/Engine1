...
void ReflectionShadingComputeShader::setParameters( ID3D11DeviceContext& deviceContext, const float3& cameraPos, const int level,
                                                    ...
                                                    const std::shared_ptr< Texture2DSpecBind< TexBind::ShaderResource, uchar4 > > previousReflectionTermTexture )
{
    ...
    { // Set input buffers and textures.
        ...
        ID3D11ShaderResourceView* resources[ resourceCount ] = { 
            ...
            previousReflectionTermTexture ? previousReflectionTermTexture->getShaderResourceView() : nullptr
        };
