...
void ShadingNoShadowsComputeShader::compileFromFile( std::string path, ID3D11Device& device )
{
    if ( m_compiled ) throw std::exception( "ShadingNoShadowsComputeShader::compileFromFile - Shader has already been compiled." );
    ...
    { // Compile the shader.
        ...
        if ( result < 0 ) {
            if ( errorMessage ) {
                ...
                throw std::exception( ( std::string( "ShadingNoShadowsComputeShader::compileFromFile - Compilation failed with errors: " ) + compileMessage ).c_str() );
            } else {
                throw std::exception( "ShadingNoShadowsComputeShader::compileFromFile - Failed to open file." );
            }
        }
        ...
        if ( result < 0 ) throw std::exception( "ShadingNoShadowsComputeShader::compileFromFile - Failed to create shader." );
    }
