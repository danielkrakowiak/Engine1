...
class TextVertexShader : public VertexShader {

public:
	TextVertexShader( );
	virtual ~TextVertexShader( );
...
private:
	...
	TextVertexShader( const TextVertexShader& ) = delete;
	TextVertexShader& operator=( const TextVertexShader& ) = delete;
};
