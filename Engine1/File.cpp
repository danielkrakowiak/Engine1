...
std::shared_ptr< std::vector<unsigned char> > File::loadBinary( const std::string& path ) {
	...
	try {
		...
		throw std::exception( "File::loadBinary - Error occured." );
	}
}

std::shared_ptr< std::vector<char> > File::loadText( const std::string& path ) {
