...
namespace Engine1
{
	...
	class ShadowMapRenderer
	{
        ...
        void setRenderTarget( std::shared_ptr< DepthTexture2D< float > > renderTarget );
        ...
        std::shared_ptr< DepthTexture2D< float > > getRenderTarget();
		...
		// Render targets.
		std::shared_ptr< DepthTexture2D< float > > m_renderTarget;
