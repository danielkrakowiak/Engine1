...
float CombiningFragmentShader2::s_positionDiffMul = 1.0f;
float CombiningFragmentShader2::s_normalDiffMul = 1.0f;
float CombiningFragmentShader2::s_positionNormalThreshold = 1.0f;
