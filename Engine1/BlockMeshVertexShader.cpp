...
{
	if ( compiled ) throw std::exception( "BlockMeshVertexShader::compileFromFile - Shader has already been compiled" );
...
{
	if ( !compiled ) throw std::exception( "BlockMeshVertexShader::setParameters - Shader hasn't been compiled yet" );
...
{
	if ( !compiled ) throw std::exception( "BlockMeshVertexShader::getInputLauout() - Shader hasn't been compiled yet." );
