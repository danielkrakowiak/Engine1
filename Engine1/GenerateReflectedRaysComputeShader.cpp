...
{
    if ( compiled ) throw std::exception( "GenerateReflectedRaysComputeShader::compileFromFile - Shader has already been compiled." );
...
{
    if ( !compiled ) throw std::exception( "GenerateReflectedRaysComputeShader::setParameters - Shader hasn't been compiled yet." );
...
{
    if ( !compiled ) throw std::exception( "GenerateReflectedRaysComputeShader::unsetParameters - Shader hasn't been compiled yet." );
